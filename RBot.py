...
async def deactivate(ctx):
  ...
  await conn.execute('INSERT INTO servers(id, forbidden) VALUES($1, $2) ON CONFLICT (id) DO UPDATE SET forbidden = array_append(forbidden, comm_to_deactivate)', current_server, comm_to_deactivate)
  await conn.close()
